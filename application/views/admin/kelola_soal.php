	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom2" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl2[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom3" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl3[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom4" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl4[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom5" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl5[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom6" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl6[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom7" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl7[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom8" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl8[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom9" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl9[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
	    ...
	    text-align: center;"></td>
			    ...
			    text-align: center;">
		    								...
		    								<div class="radio-choice" style="display: flex; flex-direction: column;">
				    							...
				    							<label class="form-check-label" for="jawaban-empat">
				    								<input type="text" name="tbdbaris<?php echo $i ?>kolom10" id="pilihandbaris<?php echo $i ?>kolom1" value="<?php echo $jl10[3] ?>" maxlength="1" style="width: 28px;
			    text-align: center;">
				    							</label>	
		    								</div>
										</div>	
